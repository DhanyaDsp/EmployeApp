package com.ey.pwbc.ui.issued_wallet
...
class IssuedWalletFragment : Fragment() {
...
//        })
    ...
    private fun fetchData() {
        ...
        voucherList.add(Voucher("Borsone sportivo", "€ 899,00", R.drawable.ic_store))
        voucherList.add(Voucher("Tuta", "€ 760,00", R.drawable.ic_store))
        voucherList.add(Voucher("Borsone sportivo", "€ 87,00", R.drawable.ic_store))
