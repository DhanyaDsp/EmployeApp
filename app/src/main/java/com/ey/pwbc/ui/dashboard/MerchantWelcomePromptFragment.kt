...
import kotlinx.android.synthetic.main.merchant_welcome_prompt.view.*
import kotlinx.android.synthetic.main.post_scan_fragment.view.*

class MerchantWelcomePromptFragment : Fragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance(scan: ScanStatus) = MerchantWelcomePromptFragment().apply {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.merchant_welcome_prompt, container, false)
        root.txt_refresh_view.setOnClickListener {
